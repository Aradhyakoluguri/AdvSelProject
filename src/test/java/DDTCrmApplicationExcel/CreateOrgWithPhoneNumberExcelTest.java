...
public class CreateOrgWithPhoneNumberExcelTest {
	@Test
	public void createorgwithphone() throws InterruptedException, IOException {
		...
		ExcelFileUtility exutil = new ExcelFileUtility();
		 String orgname = exutil.fetchDataFromExcel("Organization", 7, 2);
		...
		driver.findElement(By.id("phone")).sendKeys(orgphno);
		//identify save btn and click on it
				...
				if(verifyphone.getText().contains(orgphno)) {
